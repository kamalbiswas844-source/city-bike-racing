...
export class Backend implements backendInterface {
    ...
    async addFile(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFile(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addNote(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteFileById(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFileById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteNoteById(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteNoteById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFiles(): Promise<Array<FileEntry>> {
        if (this.processError) {
            try {
